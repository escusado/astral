...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a_plane, file$1, 17, 2, 380);
    			add_location(a_entity1, file$1, 12, 0, 207);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (18:4) {#each row as cell, y}
    function create_each_block_1(ctx) {
    	let a_box;
    	let a_box_scale_value;
    	...
    	const block = {
    		c: function create() {
    			a_box = element("a-box");
    			set_custom_element_data(a_box, "scale", a_box_scale_value = `${cellSize} ${cellSize} ${cellSize}`);
    			set_custom_element_data(a_box, "transparent", "");
    			set_custom_element_data(a_box, "opacity", "0.1");
    			set_custom_element_data(a_box, "position", a_box_position_value = `${/*x*/ ctx[4] * cellSize - /*offset*/ ctx[0]} 1 ${/*y*/ ctx[7] * cellSize - /*offset*/ ctx[0]}`);

    			set_custom_element_data(a_box, "conway", a_box_conway_value = {
    				id: { x: /*x*/ ctx[4], y: /*y*/ ctx[7], z: 0 }
    			});

    			add_location(a_box, file$2, 18, 6, 540);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a_box, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(18:4) {#each row as cell, y}",
    		ctx
    	});
    ...
    // (17:2) {#each conwayGridEl as row, x}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(17:2) {#each conwayGridEl as row, x}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	let a_entity;
    	let each_value = /*conwayGridEl*/ ctx[1];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a_entity, file$2, 15, 0, 460);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*conwayGridEl, cellSize, offset*/ 3) {
    				each_value = /*conwayGridEl*/ ctx[1];
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ("conwayGridEl" in $$props) $$invalidate(1, conwayGridEl = $$props.conwayGridEl);
    	};
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_custom_element_data(a_scene, "conway", a_scene_conway_value = { size: 200 });
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(script, file$4, 25, 4, 747);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$4, 31, 0, 860);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
