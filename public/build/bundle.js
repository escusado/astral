...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a_box = element("a-box");
    			t3 = space();
    			a_sphere0 = element("a-sphere");
    			t4 = space();
    			a_sphere1 = element("a-sphere");
    			t5 = space();
    			...
    			add_location(a_box, file$2, 12, 2, 307);
    			set_custom_element_data(a_sphere0, "position", "0 3.75 -5");
    			set_custom_element_data(a_sphere0, "radius", "1.25");
    			set_custom_element_data(a_sphere0, "color", "#EF2D5E");
    			set_custom_element_data(a_sphere0, "shadow", "");
    			set_custom_element_data(a_sphere0, "dynamic-body", "");
    			add_location(a_sphere0, file$2, 18, 2, 420);
    			set_custom_element_data(a_sphere1, "position", "0 3.75 -5");
    			set_custom_element_data(a_sphere1, "radius", "1.25");
    			set_custom_element_data(a_sphere1, "color", "#EF2D5E");
    			set_custom_element_data(a_sphere1, "shadow", "");
    			set_custom_element_data(a_sphere1, "dynamic-body", "");
    			add_location(a_sphere1, file$2, 24, 2, 532);
    			...
    			add_location(a_cylinder, file$2, 30, 2, 644);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (script0.src !== (script0_src_value = "//cdn.rawgit.com/donmccurdy/aframe-physics-system/v4.0.1/dist/aframe-physics-system.min.js")) attr_dev(script0, "src", script0_src_value);
    			add_location(script0, file$3, 25, 4, 435);
    			if (script1.src !== (script1_src_value = "https://unpkg.com/aframe-environment-component@1.1.0/dist/aframe-environment-component.min.js")) attr_dev(script1, "src", script1_src_value);
    			add_location(script1, file$3, 30, 4, 589);
    		},
    		m: function mount(target, anchor, remount) {
    			...
    			dispose = [
    				listen_dev(script0, "load", /*onLoad*/ ctx[3], false, false, false),
    				listen_dev(script1, "load", /*onLoad*/ ctx[3], false, false, false)
    			];
    		},
    		p: noop,
    		d: function destroy(detaching) {
    ...
    function create_fragment$3(ctx) {
    	...
    	let current;
    	let dispose;
    	let if_block0 = /*isAframeLoaded*/ ctx[0] && create_if_block_1(ctx);
    	let if_block1 = /*loaded*/ ctx[1] === 2 && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			if (script.src !== (script_src_value = "https://aframe.io/releases/1.0.4/aframe.js")) attr_dev(script, "src", script_src_value);
    			add_location(script, file$3, 19, 2, 306);
    			add_location(main, file$3, 39, 0, 767);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor, remount) {
    			...
    			current = true;
    			if (remount) dispose();
    			dispose = listen_dev(script, "load", /*aFrameLoaded*/ ctx[2], false, false, false);
    		},
    		p: function update(ctx, [dirty]) {
    			if (/*isAframeLoaded*/ ctx[0]) {
    				if (if_block0) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const aFrameLoaded = () => {
    		$$invalidate(0, isAframeLoaded = true);
    	};

    	let loaded = 0;

    	const onLoad = () => {
    		$$invalidate(1, loaded++, loaded);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		if ("name" in $$props) $$invalidate(4, name = $$props.name);
    		if ("isAframeLoaded" in $$props) $$invalidate(0, isAframeLoaded = $$props.isAframeLoaded);
    	...
    	return [isAframeLoaded, loaded, aFrameLoaded, onLoad, name];
    }

    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { name: 4 });
